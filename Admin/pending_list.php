<?php
  $title = "LEFMOGIV | Pending Applications List";
  $title_short = "PAL";
    ...
    <div class="main-inner">
      <div class="container">
        <div class="section-header">
            <h1 style="font-size: 24px; font-weight: 700;">Pending Applicant List</h1>
            <p style="font-size: 17px; font-weight: 300;">Home / Applicant / Pending Applicant</p>
        </div>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
...
<div id="applicantModal" class="applicant-modal">
    <div class="modal-content-approveuser">
        ...
        <button class="btn btn-ok" onclick="openConfirmModal()">Mark as with Complete Requirement</button>
        </div>
    </div>
</div>
<div id="confirmModal" class="applicant-modal" style="display:none;">
    ...
    <div class="modal-title-sure text-center p-4">Are you sure you want to approve this user?</div>
        <div class="modal-actions">
...
<div id="successModal" class="applicant-modal" style="display:none;">
    ...
    <div class="modal-title-sure text-center p-4">User has been Cuccessfully Approved!</div>
        <div class="modal-actions">
...
<div id="rejectModal" class="applicant-modal">
    <div class="modal-content-rejecteduser" style="max-width: 800px;">
...
<div id="rejectConfirmModal" class="applicant-modal" style="display:none;">
    <div class="modal-content-rejectuser">
        ...
        <div class="modal-title-sure text-center p-4">Are you sure you want to reject this applicant?</div>
        <div class="modal-actions">
...
<div id="rejectSuccessModal" class="applicant-modal" style="display:none;">
    <div class="modal-content-successful-reject">
        ...
        <div class="modal-title-sure text-center p-4">Applicant has been successfully rejected.</div>
        <div class="modal-actions">
