...
<head>
  ...
  <link href="assets/css/deploy.css" rel="stylesheet">
</head>
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
              <li>
                  <a class="dropdown-item d-flex align-items-center" href="applicantprofile.html">
    ...
    <li class="nav-heading">Navigation</li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#">
          <i class="bi bi-grid"></i>
          <span style="color: #4154f1" >Deployment History</span>
        </a>
      </li>
  ...
  <div class="card mb-4 company-history">
    <div class="card-body">
      <h2 class="card-title">Company Activity History</h2>
      <table class="table table-striped table-bordered" id="historyTable">
        <thead>
          <tr>
            <th>Date</th>
            <th>Company Name</th> <!-- Changed from Activity to Company Name -->
            <th>Download</th>
          </tr>
        </thead>
        <tbody>
